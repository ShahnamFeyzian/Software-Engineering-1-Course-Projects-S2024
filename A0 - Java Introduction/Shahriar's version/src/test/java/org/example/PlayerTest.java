...
public class PlayerTest {
    ...
    void addMembershipTest() {
        ...
        Membership m1 = new Membership("name", d1, d2);
        Membership m2 = new Membership("name", d3, d4);
        Membership m3 = new Membership("name", d1, d3);
        Membership m4 = new Membership("name", d2, d4);
    ...
    void totalMembershipDaysTest() throws Exception {
        ...
        Assertions.assertEquals(795, pl.getDaysAsMemberByTeam("Barca"));
        Assertions.assertEquals(793, pl.getDaysAsMemberByTeam("Real"));
    }
}
