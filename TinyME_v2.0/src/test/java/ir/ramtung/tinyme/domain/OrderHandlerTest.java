...
public class OrderHandlerTest {
    ...
    void iceberg_order_behaves_normally_before_being_queued() {
        ...
        OrderHandler myOrderHandler = new OrderHandler(new ApplicationServices(securityRepository, brokerRepository, shareholderRepository, new Matcher()), mockEventPublisher);
